...
const name_q: string = "Name";
const country_q: string = "Country";
const job_q: string = "Job";
      ...
      <div className="w-[500px] border rounded m-4">
        ...
        <div className="p-4 flex">
          <div className="w-full">
            ...
            <span className="w-1/2 text-sm inline-block">
              *Country space holder*
            </span>
          </div>
          <button className="px-3 text-sm text-green-700 border rounded border-solid border-green-600">
            {add}
          </button>
        </div>
        <div className="p-4 flex">
